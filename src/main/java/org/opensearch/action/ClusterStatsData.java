...
//    /**
//     * Try to extract and parse value from settings for a given key.
//     * First it tries to parse it as a RatioValue (pct), then as a byte size value.
//     * It assigns parsed value to corresponding argument references (passed via array hack).
//     * If parsing fails, the method fires an exception, however; this should not happen because
//     * OpenSearch has already parsed and validated these values before.
//     */
...
//                        // TODO(lukas-vlcek): log.debug("This went wrong, but 'Keep Calm and Carry On'")
